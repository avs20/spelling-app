...
@app.function(
    ...
    env={
        "TURSO_DATABASE_URL": os.getenv("TURSO_PREPROD_DATABASE_URL") or os.getenv("TURSO_DATABASE_URL"),
        "TURSO_AUTH_TOKEN": os.getenv("TURSO_PREPROD_AUTH_TOKEN") or os.getenv("TURSO_AUTH_TOKEN"),
    },
    min_containers=1,
    timeout=300,
)
